    ...
    try {
        ...
        if (difficulty && currentUser && currentUserSocketId) {
            ...
            if (matchExistUser1 && !matchExistUser1.isPendingMatch) {
                ...
                console.log(`${currentUser} is already in a match! Existing Room Id: ${existingRoomId}`);
                ...
                console.log(`Controller ERROR: currentUser (${currentUser}) is already in a pending match.`)
